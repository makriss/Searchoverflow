...
(function(s, c) {
    ...
    c.module("ngSanitize", []).provider("$sanitize", function() {
        ...
        this.$get = ["$$sanitizeUri", function(a) {
            ...
            return function(e) {
                var d = [];
                K(e, C(d, function(b, d) { return !/^unsafe:/.test(a(b, d)) }));
                return d.join("")
            }
        }];
        ...
        var z = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
            ...
            N = function(a, e) {
                ...
                return c.querySelector("svg") ?
                    (c.innerHTML = '<svg><p><style><img src="</style><img src=x onerror=alert(1)//">', c.querySelector("svg img") ? d : b) : function(b) {
                        b = "<remove></remove>" + b;
                        try { b = encodeURI(b) } catch (d) { return }
